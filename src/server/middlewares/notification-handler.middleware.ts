...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'benefit.delete': {
    roles: ['owner'],
    key: 'admin-deleted-benefit',
    tenantPath: ['company', 'employee', 'benefit'],
    userPath: [],
  },
  'contract.create': { roles: ['owner'], key: 'admin-created-contract', tenantPath: [], userPath: [] },
  'absence.update': { roles: ['owner'], key: 'admin-updated-absence', tenantPath: [], userPath: [] },
  'job_posting.delete': { roles: ['owner'], key: 'admin-deleted-job-posting', tenantPath: [], userPath: [] },
  'onboarding.create': { roles: ['owner'], key: 'admin-managed-onboarding', tenantPath: [], userPath: [] },
};
